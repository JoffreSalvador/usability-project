...
function saveListeningGameScoreToFirestore(score) {
    ...
    firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
            ...
            .then(() => console.log("Listening game score saved:", score))
            .catch((err) => console.error("Error saving listening score:", err));
        } else {
